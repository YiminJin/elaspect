    ...
    namespace Assembly
    {
      namespace Scratch
      {
        ...
        struct ThermoSystem : public ScratchBase<dim>
        {
          ...
          std::vector<Tensor<1,dim>>    face_grad_phi_T;
          std::vector<double>           neighbor_face_phi_T;
          std::vector<Tensor<1,dim>>    neighbor_face_grad_phi_T;
  ...
  namespace Assemblers
  {
    ...
    class Manager
    {
      public:
        ...
        std::vector<std::unique_ptr<Assemblers::Interface<dim>>> thermo_system_on_interior_face;
