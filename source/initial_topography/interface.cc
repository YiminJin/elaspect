...
namespace elaspect
{
  namespace internal
  {
    ...
    {
      template <>
      std::list<internal::Plugins::PluginList<InitialTopography::Interface<2> >::PluginInfo> *
      internal::Plugins::PluginList<InitialTopography::Interface<2> >::plugins = nullptr;

      template <>
      std::list<internal::Plugins::PluginList<InitialTopography::Interface<3> >::PluginInfo> *
      internal::Plugins::PluginList<InitialTopography::Interface<3> >::plugins = nullptr;
    }
  }
